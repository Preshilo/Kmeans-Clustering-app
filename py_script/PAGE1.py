...
def func_page_1():
    ...
    if all(key in st.session_state for key in ('num_clus', 'pca_features', 'pca_df', 'pca3','df_col_name')):
    ...
    raw_input = st.sidebar.text_input("Enter the user's power usage")
    ...
    if raw_input == "":
        ...
        data_input = raw_input.replace(" ", "").split(',')
